...
## Related Paper
One needs to have the proper Pension Register data in order to run this code. Since 
...
to the kamila-clustered Swiss Pension Register thanks to the package [`rrclust`](https://github.com/asam-group/rrclust). 

## Examples

Since the Pension Register data are not public, we offer two examples with randomly 
...
You can see the results in the csv named `KM_RES_FINAL.csv`. The best number of 
...
path_graphs <- file.path(tempdir(), "graphs")
